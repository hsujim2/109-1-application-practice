    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_start.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(flag){
                    btn_start.setText("pulse");
                    Toast.makeText(MainActivity.this,"start timing",Toast.LENGTH_SHORT).show();
                }
                else {
                    btn_start.setText("start");
                    Toast.makeText(MainActivity.this,"timing pulse",Toast.LENGTH_SHORT).show();
                }
